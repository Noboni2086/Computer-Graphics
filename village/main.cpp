...
void BAnaa_Tree() {
   ...
   glVertex2f(11.6136826260869, 10.328268976953); // V4
  //  glVertex2f(11.8846219350799, 10.8040528480322); // W4
    glVertex2f(12.258763846591, 10.743568281115);   // Z4
    glVertex2f(12.8890223727909, 10.916222333087);  // A4


    glVertex2f(13.4,11); // C4

    // Add vertex using the coordinates you provided
    glVertex2f(13.89353375751621, 11.0297031743066); // C1
    glVertex2f(13.97847787871992, 10.32091296978);   // D1
    glVertex2f(13.505080925146, 10.1808896222483);   // E1
    glVertex2f(13.2433426571343, 10.8328193020716);  // F1
    glVertex2f(13.0813578191061, 10.1021222460297);  // G1
    glVertex2f(12.8, 10);                            // H1
    glVertex2f(12.3769330933792,10.5309513560842);   // I1
    glVertex2f(12.3638056771102,9.9139627914405);     // J1
    glVertex2f(12.0837541303079, 9.080943612883);    // K1
...
glVertex2f(11.6313157712323,11.9522779876076);
glVertex2f(12.2394704087606,12.5466109288284);
glVertex2f(12.6001462182656,12.7071454940444);
glVertex2f(14.4,13.4);
glVertex2f(14.285346787779,12.4476015589106);
glVertex2f(13.1479675665626,12.7862081454155);
glVertex2f(13.0385383911296,11.8953819230244);
glVertex2f(12.6071168005935,11.6710426959457);
glVertex2f(12.0721540283287,12.1801201727782);
glVertex2f(11.5814946964072,10.3343640905879);
...
{  glColor3ub(50, 205, 50);
    ...
    glBegin(GL_POLYGON);
glVertex2f(9.9704700386321,13.2705940147554);
glVertex2f(10.6931999444529,12.5210589461397);
glVertex2f(10.9556317937865,11.8807252337658);
glVertex2f(11.2983456659721,10.6343703428305);
glVertex2f(11.3276370401046,10.3414566015055);
glVertex2f(11.6153826260859,10.3238268976953);
glVertex2f(11.8744093572446,11.3861822788979);
glVertex2f(11.8255904003571,11.9720097615479);
glVertex2f(11.6791335296946,12.7042941148604);
glVertex2f(11.2246829256294,13.3834828590523);
glVertex2f(10.6832268091896,13.7978387491403);
  glEnd();
...
glVertex2f(11,13);
glVertex2f(10.6931999444529,12.5210589461397);
glVertex2f(11.5349908172074,12.3780583570722);
glVertex2f(10.9556317937865,11.8807252337658);
glVertex2f(11.2983456659721,10.6343703428305);
glVertex2f(11.3276370401046,10.3414566015055);
...
glVertex2f(11.3276370401046,10.3414566015055);
glVertex2f(11.2983456659721,10.6343703428305);
glVertex2f(10.3903130678646,11.5619305236929);
glVertex2f(9.6775562973071,12.0891752580779);
glVertex2f(9.0917288146571,12.2942148770054);
glVertex2f(8.3984996268546,12.3039786683829);
glVertex2f(8.0665307200196,12.1575217977204);
glVertex2f(8.1251134682846,11.2690167823679);
  glEnd();
...
glVertex2f(8.1251134682846,11.2690167823679);
glVertex2f(9.1483853285335,11.9900507888264);
glVertex2f(9.0917288146571,11.2494891996129);
glVertex2f(9.5,11);
glVertex2f(10.2261015534177,11.4268222089875);
glVertex2f(10.1462182834271,10.566023803188);
  glEnd();
}
