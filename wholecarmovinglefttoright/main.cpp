...
float carPosition = -40.0f;//-20.0f; // Initial position of the car
float carSpeed = 0.10f; // Speed of the car
...
void Car() {
    ...
    glColor3ub(105, 105, 105); //head light
    glBegin(GL_POLYGON);
    ...
    glColor3ub(0, 0, 0); //head light border
...
void update(int value) {
    ...
    if (carPosition > 40.0f) {
        carPosition = -40.0f; // Reset position to loop the car
    }
