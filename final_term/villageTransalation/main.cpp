...
void BAnaa_Tree() {
   ...
   glVertex2f(11.6136826260869+ leafOffset, 10.328268976953); // V4

  //  glVertex2f(11.8846219350799, 10.8040528480322); // W4

    glVertex2f(12.258763846591+ leafOffset, 10.743568281115);   // Z4

    glVertex2f(12.8890223727909+ leafOffset, 10.916222333087);  // A4
    ...
    glVertex2f(13.89353375751621+ leafOffset, 11.0297031743066); // C1

    glVertex2f(13.97847787871992+ leafOffset, 10.32091296978);   // D1

    glVertex2f(13.505080925146+ leafOffset, 10.1808896222483);   // E1

    glVertex2f(13.2433426571343+ leafOffset, 10.8328193020716);  // F1

    glVertex2f(13.0813578191061+ leafOffset, 10.1021222460297);  // G1

    glVertex2f(12.8+ leafOffset, 10);                            // H1

    glVertex2f(12.3769330933792+ leafOffset,10.5309513560842);   // I1

    glVertex2f(12.3638056771102+ leafOffset,9.9139627914405);     // J1

    glVertex2f(12.0837541303079+ leafOffset, 9.080943612883);    // K1
...
glVertex2f(11.6313157712323+ leafOffset,11.9522779876076);

glVertex2f(12.2394704087606+ leafOffset,12.5466109288284);

glVertex2f(12.6001462182656+ leafOffset,12.7071454940444);

glVertex2f(14.4+ leafOffset,13.4);

glVertex2f(14.285346787779+ leafOffset,12.4476015589106);

glVertex2f(13.1479675665626+ leafOffset,12.7862081454155);

glVertex2f(13.0385383911296+ leafOffset,11.8953819230244);

glVertex2f(12.6071168005935+ leafOffset,11.6710426959457);

glVertex2f(12.0721540283287+ leafOffset,12.1801201727782);

glVertex2f(11.5814946964072+ leafOffset,10.3343640905879);
...
glVertex2f(9.9704700386321+ leafOffset,13.2705940147554);

glVertex2f(10.6931999444529+ leafOffset,12.5210589461397);

glVertex2f(10.9556317937865+ leafOffset,11.8807252337658);

glVertex2f(11.2983456659721+ leafOffset,10.6343703428305);

glVertex2f(11.3276370401046+ leafOffset,10.3414566015055);

glVertex2f(11.6153826260859+ leafOffset,10.3238268976953);

glVertex2f(11.8744093572446+ leafOffset,11.3861822788979);

glVertex2f(11.8255904003571+ leafOffset,11.9720097615479);

glVertex2f(11.6791335296946+ leafOffset,12.7042941148604);

glVertex2f(11.2246829256294+ leafOffset,13.3834828590523);

glVertex2f(10.6832268091896+ leafOffset,13.7978387491403);
...
glVertex2f(11+ leafOffset,13);

glVertex2f(10.6931999444529+ leafOffset,12.5210589461397);

glVertex2f(11.5349908172074+ leafOffset,12.3780583570722);
...
glVertex2f(10.3903130678646+ leafOffset,11.5619305236929);

glVertex2f(9.6775562973071+ leafOffset,12.0891752580779);

glVertex2f(9.0917288146571+ leafOffset,12.2942148770054);

glVertex2f(8.3984996268546+ leafOffset,12.3039786683829);

glVertex2f(8.0665307200196+ leafOffset,12.1575217977204);

glVertex2f(8.1251134682846+ leafOffset,11.2690167823679);
...
glVertex2f(9.1483853285335+ leafOffset,11.9900507888264);

glVertex2f(9.0917288146571+ leafOffset,11.2494891996129);

glVertex2f(9.5+ leafOffset,11);

glVertex2f(10.2261015534177+ leafOffset,11.4268222089875);

glVertex2f(10.1462182834271+ leafOffset,10.566023803188);
...
void timer1(int value) {
    ...
    leafOffset = 0.5f * sin(value * 0.1f);
...
float carPosition = 1.0f;  // Start at the right boundary
...
void renderNightScene() {
    ...
    glTranslatef(0.0f, SkyPosition, 0.0f);
...
glScalef(3.0f, 2.2f, 1.0f);
  ...
  ball(0.7957, 3.4697, 3.28447, 1.0, 1.0, 1.0);////////////for SUn
...
glScalef(3.0f, 2.2f, 1.0f);
  ...
  ball(0.7957, 3.4697, 3.28447, 1.0, 0.8745, 0);
...

{
 ...
 if (isDay) {
  ...
  glPushMatrix();
    ...
    glTranslatef(SkyPosition, 0.0f, 0.0f);
...
////////////////////////////////tree
  ...
  ball(15.34,100+ leafOffset,80,0,0.392,0);

   ball(15.04834,131.384+leafOffset,79.6483,0,0.392,0);

  ball(15.04834,118.5107+leafOffset,70.33039,0,0.392,0);

  ball(15.04834,118.5107+leafOffset,85.33039,0,0.392,0);
